          ...
          <div className="flex items-center gap-6 shrink-0">
            {user ? (
              <div className="hidden lg:flex items-center gap-3 group relative">
                ...
                <Link
                  to="/profile"
                  className="h-10 w-10 bg-indigo-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg border-2 border-gray-800 group-hover:border-indigo-400 transition-all"
                >
              ...
              <Link
                to="/login"
                className="hidden lg:flex items-center gap-2 text-gray-200 hover:text-indigo-400 transition-colors group"
              >
          ...
          <div className="px-4 py-4 space-y-4">
            ...
            {user ? (
              <div className="border-b border-gray-700 pb-4 mb-4">
                ...
                <button
                  onClick={logout}
                  className="text-red-400 text-sm font-medium hover:text-red-300 w-full text-left"
                >
                  Cerrar Sesión
                </button>
              </div>
              ...
              <Link
                to="/login"
                className="block text-gray-200 font-medium p-2 bg-gray-700 rounded text-center"
              >
                Iniciar Sesión
              </Link>
            )}
            ...
            <Link
              to="/"
              className="block text-gray-200 font-medium p-2 hover:text-indigo-400 transition-colors"
            >
              Productos
            </Link>

            <Link to="/admin/products/new" className="block text-indigo-400 font-medium">
              + Crear Producto
            </Link>
